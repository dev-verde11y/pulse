      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center">
            <Link href="/dashboard" className="flex items-center space-x-2">
              <Image
                ...
                width={28}
                height={28}
                className="rounded-lg shadow-xl sm:w-8 sm:h-8"
                priority
              />
              <span className="text-lg sm:text-xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500 hidden xs:block">
                PULSE
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            <button className="md:hidden p-1.5 sm:p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-800/50">
              ...
              {user ? (
                <>
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    >
                      <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg group-hover:scale-105 transition-all duration-200">
            ...
            <div className="md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-1.5 sm:p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none transition-colors"
              >
                <span className="sr-only">Abrir menu principal</span>
                {!isMobileMenuOpen ? (
                  <svg className="block h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
                ) : (
                  <svg className="block h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                )}
              </button>
            </div>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-gray-900/95 backdrop-blur-md border-t border-gray-700 animate-slide-down">
          ...
          <div className="px-2 py-2 space-y-1">
            <a href="#" className="text-gray-300 hover:text-white hover:bg-gray-800/50 block px-3 py-2.5 rounded-lg text-sm font-medium flex items-center">
            ...
            <a href="#" className="text-gray-300 hover:text-white hover:bg-gray-800/50 block px-3 py-2.5 rounded-lg text-sm font-medium flex items-center">
              <svg className="h-4 w-4 mr-3 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              Populares
            </a>
            <a href="#" className="text-gray-300 hover:text-white hover:bg-gray-800/50 block px-3 py-2.5 rounded-lg text-sm font-medium flex items-center">
              <svg className="h-4 w-4 mr-3 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user && (
              <>
                ...
                <div className="px-2 space-y-1">
                  <a href="#" className="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all">
                  ...
                  <a href="#" className="flex items-center px-3 py-2.5 rounded-lg text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-all">
                    <svg className="w-4 h-4 mr-3 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                    Minha Lista
