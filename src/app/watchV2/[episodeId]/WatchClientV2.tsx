                ...
                <div className="max-w-[1920px] mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6 lg:gap-10">
                        ...
                        >
                            ...
                            <span className="font-black text-xl tracking-tighter hidden md:block"><span className="text-purple-500">P</span>ULSE <span className="text-xs bg-purple-900 px-1 rounded">V2 HLS</span></span>
                        </button>
                        ...
                        <nav className="flex items-center gap-4">
                            ...
                            >
                                <div className="flex flex-col text-left">
                                    <span className="text-[8px] font-black uppercase tracking-[0.5em] leading-none mb-1 text-purple-500/80">Série em Exibição</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className={`p-4 rounded-2xl transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] ${showEpisodeList ? 'bg-purple-600 text-white shadow-2xl shadow-purple-600/40' : 'bg-white/5 text-white/40 hover:bg-white/10 hover:text-white'}`}
                    ...
                    <div className={`flex-1 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] ${showEpisodeList ? 'lg:w-[65%]' : 'w-full'}`}>
                        ...
                        <div className="mt-20 animate-slide-up-soft">
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="max-w-4xl">
                                    <p className="text-gray-400 text-2xl leading-relaxed font-medium italic opacity-90 relative">
                                        <span className="text-purple-600 text-6xl absolute -left-10 -top-4 opacity-40">“</span>
                            ...
                            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div
                                    onClick={() => router.push(`/anime/${initialAnime.id}`)}
                                    className="group bg-gradient-to-br from-white/[0.04] to-transparent border border-white/5 rounded-[48px] p-10 flex items-center gap-10 cursor-pointer hover:border-purple-500/40 transition-all duration-700"
                                >
                                    ...
                                    <div className="flex-1">
                                        <span className="text-purple-500 text-[9px] font-black uppercase tracking-[0.4em] mb-3 block">Explorar Série</span>
                                ...
                                <div className="bg-white/[0.02] border border-white/5 rounded-[48px] p-10 flex flex-col justify-center">
                                    <div className="flex items-center justify-between mb-8 pb-8 border-b border-white/5">
                                        ...
                                        <div className="flex flex-col text-right">
                                            ...
                                            <span className="text-2xl font-black italic tracking-tighter text-purple-500">{initialAnime.rating}</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-purple-500 text-[9px] font-black uppercase tracking-[0.5em] leading-none">Playlist V2</span>
                                        </div>
                                    ...
                                    <div className="flex flex-col items-end">
                                        ...
                                        <span className="text-2xl font-black italic text-purple-500 leading-none">
                            ...
                            <div className="px-8 pb-4">
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-6 flex items-center pointer-events-none">
                                        <MagnifyingGlassIcon className={`w-5 h-5 transition-colors duration-500 ${searchQuery ? 'text-purple-500' : 'text-white/10 group-focus-within:text-purple-500'}`} />
                                    </div>
                                    <input
                                        type="text"
                                        ...
                                        className="w-full bg-white/[0.02] border border-white/5 rounded-[32px] py-5 pl-16 pr-14 text-sm font-black text-white placeholder:text-white/10 focus:outline-none focus:ring-4 focus:ring-purple-500/20 focus:bg-white/[0.05] focus:border-purple-500/30 transition-all duration-500 uppercase tracking-widest italic"
                                    />
                                    {searchQuery && (
                                        <button
                                        ...
                                        return (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    onClick={() => { if (!isCurrent) router.push(`/watchV2/${ep.id}`); }}
                                                    className={`w-full h-full group relative flex items-center gap-6 p-5 rounded-[40px] transition-all duration-500 border ${isCurrent
                                                        ? 'bg-purple-600 border-purple-400 shadow-[0_20px_40px_rgba(168,85,247,0.4)] ring-4 ring-purple-600/20'
                                                ...
                                                >
                                                    ...
                                                    <div className="text-left min-w-0 flex-1 py-1">
                                                        <span className={`text-[9px] font-black uppercase tracking-[0.2em] ${isCurrent ? 'text-purple-100' : 'text-purple-500'}`}>
